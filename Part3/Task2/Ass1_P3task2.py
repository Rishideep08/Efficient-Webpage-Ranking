...
spark = SparkSession.builder.appName("hdfs_OptimizedVersion").getOrCreate()
...
combinedlinksData_rdd = linksData_rdd.reduceByKey(lambda v1, v2: v1+v2, partitions, myHash)
...
for i in range(10):
  ...
  ranks_rdd = contributions_rdd.reduceByKey(lambda v1,v2: v1+v2, partitions, myHash)
